//! End-to-end tests for `okf serve`.
//!
...
fn assert_cmd_okf() -> assert_cmd::Command {
    assert_cmd::Command::cargo_bin("okf").expect("binary builds")
}
...
fn serve_mcp_speaks_json_rpc_on_stdout_and_status_on_stderr() {
    ...
    assert_eq!(response["result"]["serverInfo"]["name"], "okf");
