...
```
okft serve [BUNDLE] (--mcp | --web) [--addr HOST:PORT] [--today YYYY-MM-DD]
```
...
`related`, and `trust`. See [the MCP crate](../architecture/okf-toolkit-mcp.md)
for why both.
...
[the web crate](../architecture/okf-toolkit-web.md).
...
okft serve --web ./knowledge --addr 0.0.0.0:9000
```
