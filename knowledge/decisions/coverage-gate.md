...
both written that way. The symptom is a phantom uncovered line that no test can
reach, and `--text` and lcov exports both report it as covered, so the summary
